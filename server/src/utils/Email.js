...
module.exports = class Email {
  constructor(user, OTP) {
    ...
    this.OTP = OTP;
    this.from = `Quranuceednet <${process.env.EMAIL_FROM}>`;
  }
  ...
  async sendWelcome() {
    const html = `
      <h1>Welcome to the Quranuceednet, ${this.firstName}!</h1>
      <p>We are excited to have you onboard.</p>
      <p>Click <a href="${this.OTP}">here</a> to get verified.</p>
    `;

    await this.send(html, "Welcome to the Quranuceednet!");
  }
  ...
  async sendForgetPasswordOTP() {
    const html = `
      <div style="font-family: Arial, sans-serif; color: #333; padding: 20px; max-width: 600px; margin: auto;">
        ...
        <p><strong>The Quranuceednet</strong></p>
      </div>  
    `;
